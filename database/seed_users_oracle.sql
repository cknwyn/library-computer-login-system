...
BEGIN
    ...
    VALUES ('21-0001-101', 'Marco', 'Pineda', 'Pineda, Marco', 'marco.pineda@auf.edu.ph', 'student', 
        ...
        'Male', '3rd Year', '0917-111-2222', 'College of Computer Studies', TO_DATE('2028-06-30','YYYY-MM-DD'), '5', 'Undergraduate', TO_DATE('2003-05-14','YYYY-MM-DD'), '$2y$10$dPErZCxWf7Ifp5PiFL67OuXsJaxDiCbGCsDfUGg5TvF46AQhLfE/2');
    ...
    VALUES ('21-0002-202', 'Stella', 'Umali', 'Umali, Stella', 'stella.umali@auf.edu.ph', 'student', 
        ...
        'Female', '4th Year', '0918-222-3333', 'College of Allied Medical Professions', TO_DATE('2027-12-15','YYYY-MM-DD'), '2', 'Undergraduate', TO_DATE('2002-11-20','YYYY-MM-DD'), '$2y$10$dPErZCxWf7Ifp5PiFL67OuXsJaxDiCbGCsDfUGg5TvF46AQhLfE/2');
    ...
    VALUES ('24-0003-001', 'Paolo', 'Guiao', 'Guiao, Paolo', 'paolo.guiao@auf.edu.ph', 'staff', 
        ...
        'Male', 'Faculty', '0919-333-4444', 'Senior Professor', TO_DATE('2035-01-01','YYYY-MM-DD'), '1', 'Postgraduate', TO_DATE('1978-04-12','YYYY-MM-DD'), '$2y$10$dPErZCxWf7Ifp5PiFL67OuXsJaxDiCbGCsDfUGg5TvF46AQhLfE/2');
    ...
    VALUES ('21-0004-404', 'Mia', 'Lansangan', 'Lansangan, Mia', 'mia.lansangan@auf.edu.ph', 'student', 
        ...
        'Female', '2nd Year', '0920-444-5555', 'College of Nursing', TO_DATE('2029-05-20','YYYY-MM-DD'), '8', 'Undergraduate', TO_DATE('2004-09-30','YYYY-MM-DD'), '$2y$10$dPErZCxWf7Ifp5PiFL67OuXsJaxDiCbGCsDfUGg5TvF46AQhLfE/2');
